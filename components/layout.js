...
const name = 'loom';
export const siteTitle = 'loom.nyc';
    ...
    <div className={styles.container}>
      ...
      <div className={`${styles.iframeContainer}`}>
        ...
        <div className={`${styles.footer}`}>
          ...
          <span className={`${utilStyles.dandelionText} ${utilStyles.headingSm3}`}> YSL Summer '24 - SebastiAn </span>
          
        </div>
        <div className={`${styles.player}`}>
          <button className={`${styles.playButton} ${utilStyles.dandelionText}`} onClick={() => document.querySelector('audio').play()}>
            play
          </button>
        </div>
        <audio src="/ysl.m4a" autoPlay loop hidden />
      </div>
